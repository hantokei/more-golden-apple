...
public class CrimsonGoldenApple {
    public static final Consumable CRIMSON_GOLD_APPLE = Consumable.builder()
            ...
            .onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE,3600,0)))
            .onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(ModEffects.GOLDEN_GLOW,6000,0)))
            .build();

    public static final Consumable ENCHANTED_CRIMSON_GOLD_APPLE = Consumable.builder()
            ...
            .onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE,36000,0)))
            .onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(ModEffects.GOLDEN_GLOW,36000,0)))
            .build();
}
